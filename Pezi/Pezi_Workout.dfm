object Frame_Workout: TFrame_Workout
  Left = 0
  Top = 0
  Width = 870
  Height = 636
  ...
  object Panel_Bottom: TPanel
    ...
    Height = 235
    TabOrder = 1
    object StringGrid_Workout: TStringGrid
      Left = 1
      Top = 1
      Width = 807
      Height = 233
      ...
      ParentFont = False
      TabOrder = 0
      OnSelectCell = StringGrid_WorkoutSelectCell
      OnSetEditText = StringGrid_WorkoutSetEditText
      ColWidths = (
        26
        143
        450
